...
3. Шаг 3 (ВЫБОР ДЕЙСТВИЯ): В зависимости от задачи сделай одно из действий:
   ...
   - ВАРИАНТ Б (Клики мышью): Переведи координаты в пиксели: X = (Твой X / 1000) * Ширина, Y = (Твой Y / 1000) * Высота. Вызови "переместить мышь", затем "нажать кнопку мыши". В конце вызови "task_completed".
   - ВАРИАНТ В (Печать текста): Если нужно ввести текст, вызови "напечатать текст", затем "task_completed".

ПРАВИЛО: Ты НЕ имеешь права завершать работу, пока не вызовешь "task_completed".
