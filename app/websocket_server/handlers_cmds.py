...
async def handle_target_command(websocket, data):
    ...
    try:
        ...
        heavy_acts = ["нажать кнопку мыши", "переместить мышь", "напечатать текст", "request_screenshot", "task_completed", "голосовой ответ"]
...
ПРАВИЛА:
1. Сначала вызови action_type="request_screenshot", чтобы запросить скриншот.
2. Изучив скриншот, система пришлет тебе саму картинку и РАЗРЕШЕНИЕ МОНИТОРА (например, 1920x1080).
3. Вычисли координаты нужного элемента. ВАЖНО: Твоё внутреннее зрение работает в сетке 1000x1000. Ты ОБЯЗАН перевести эти координаты в реальные пиксели экрана по формуле: X_реальный = (X_твой / 1000) * Ширина_экрана, Y_реальный = (Y_твой / 1000) * Высота_экрана.
4. Отправь вычисленные РЕАЛЬНЫЕ ПИКСЕЛИ в инструмент action_type="переместить мышь" с action_value="X, Y" (целые числа). Затем вызови "нажать кнопку мыши" с action_value="лкм".
5. Обязательно вызови action_type="task_completed", когда закончишь визуальную задачу.
6. Вызови "голосовой ответ" для финальной озвучки итога работы.
