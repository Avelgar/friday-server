...
ПРАВИЛА:
1. Если пользователь говорит про другое устройство, то сначала сделай запрос на доступные устройства(check_network_devices), чтобы понять с чем тебе работать.
