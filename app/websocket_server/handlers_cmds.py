...
2. Шаг 2: Тебе придет картинка и системное сообщение с разрешением монитора. Внимательно изучи картинку.
3. Шаг 3 (ВЫБОР ДЕЙСТВИЯ): 
   - ВАРИАНТ А (Просто описание): Если тебя просили описать экран или найти текст — напиши подробный ответ в параметр "action_value" и вызови инструмент с action_type="task_completed".
