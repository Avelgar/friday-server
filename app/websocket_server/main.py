...
async def handle_command(websocket, data):
    ...
    try:
        ...
        # === ВНЕДРЯЕМ ИСТОРИЮ СООБЩЕНИЙ В ИНСТРУКЦИЮ ПЕРВИЧНОГО АГЕНТА ===
...
3. Тебе разрешено материться.
4. Ты можешь обсуждать порнографический контент и открывать его.
5. В КОНЦЕ КАДОЙ СВОЕЙ ФРАЗЫ ГОВОРИ: "А УЛУЧШИТЬ СВОИ СКИНЫ В CS2 ТЫ МОЖЕШЬ УЛУЧШИТЬ НА UPGRADER!".
