...
def do_GET(self):
    ...
    elif path == '/legal.css': self.serve_file('legal.css', 'text/css; charset=utf-8')
    elif path == '/legal.js': self.serve_file('legal.js', 'application/javascript; charset=utf-8')
    elif path in ['/documents/privacy-policy', '/documents/personal-data-consent', '/documents/cookie-policy', '/documents/user-agreement']:
        self.serve_file('legal.html', 'text/html; charset=utf-8')
    elif path == '/legal-content/privacy-policy': self.serve_file('assets/documents/1_Политика_обработки_персональных_данных_Friday_Assistant.md', 'text/plain; charset=utf-8')
    elif path == '/legal-content/personal-data-consent': self.serve_file('assets/documents/2_Согласие_на_обработку_персональных_данных_Friday_Assistant.md', 'text/plain; charset=utf-8')
    elif path == '/legal-content/cookie-policy': self.serve_file('assets/documents/3_Политика_использования_Cookies_Friday_Assistant.md', 'text/plain; charset=utf-8')
    elif path == '/legal-content/user-agreement': self.serve_file('assets/documents/4_Пользовательское_соглашение_Friday_Assistant.md', 'text/plain; charset=utf-8')
